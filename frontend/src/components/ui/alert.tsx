  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground backdrop-blur-sm",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-warning/70 text-warning-foreground [&>svg]:text-warning-foreground bg-warning/90 shadow-lg",
        success:
          "border-success/70 text-success-foreground [&>svg]:text-success-foreground bg-success/90 shadow-lg",
      },
    },
    defaultVariants: {
      variant: "default",
