        ...
        with open(filename) as f:
            ...
            for row in preader:
                if header:
                    ...
                    lines = []
                    lines.append(
                        ["1260", "Total", row[header.index("Total")].strip("$")]
                    )
                    ...
                    lines.append(
                        [
                            "6261",
                            "Commission",
                            "-" + row[header.index("Commission")].strip("%"),
                        ]
                    )
                    lines.append(
                        [
                            "6260",
                            "Issue Adjustments",
                            row[header.index("Issue Adjustments")].strip("$"),
                        ]
                    )
                    lines.append(
                        [
                            "6260",
                            "Dispute Adjustments",
                            row[header.index("Dispute Adjustments")].strip("$"),
                        ]
                    )
                    lines.append(
                        [
                            "6260",
                            "Other Adjustments",
                            row[header.index("Other Adjustments")].strip("$"),
                        ]
                    )
                    lines.append(
                        ["6260", "Returns", row[header.index("Returns")].strip("$")]
                    )
